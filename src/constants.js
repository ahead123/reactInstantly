...
export const API_URL = `https://api.instagram.com/oauth/authorize/?client_id=${CLIENT_ID}&redirect_uri=https://reactinstantly.herokuapp.com/&response_type=token`;
export const TEST_API_URL = `https://api.instagram.com/oauth/authorize/?client_id=${CLIENT_ID}&redirect_uri=http://localhost:4000/&response_type=token`;
